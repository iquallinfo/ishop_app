...
componentDidMount(){
  ...
  if(this.props.route.params.category_id!=null)
  {
    this.getProducts(this.props.route.params.category_id)
  }
  else
  {
     this.getProducts();
...
getProducts=(value,value2)=>
{
  ...
  .then((responseJson) => {
   ...
   //console.log(responseJson.current_page)
     ...
     if(this.state.cat_reselect)
     {
      this.setState({
        sel_category_filter: this.props.route.params.category_id,
        cat_reselect:false
      });
     }
